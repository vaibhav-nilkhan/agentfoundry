    ...
    throw recovery.error;
        ...
        <section className="py-24 px-6 bg-secondary/30">
          <div className="container mx-auto max-w-6xl">
            ...
            {/* Top Infrastructure Skills */}
            <div className="mb-12">
              <h3 className="text-xl font-semibold mb-6">🔥 Top Infrastructure Skills</h3>
                ...
                <Link href="/skills/cost-predictor-optimizer">
                  <Card className="hover-lift h-full border-2 border-primary/20">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Prevent $500/day billing surprises with pre-execution cost estimation and budget enforcement.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </Link>
